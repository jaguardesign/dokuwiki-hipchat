 ...
 */
  ...
  $lang['hipchat_namespaceroom'] = "Specify a HipChat room for each namespace in the format 'namespace=room'. For example, 'engineering=Developers,marketing=RedTeam'.";
